...
public class ExceptionTypes {
	...
	//	Thread.sleep(2000); //checked exception as the compiler checks it
		...
		FileInputStream fis = new FileInputStream(filePath); //wehn wotking with file there might always be exception so the compiler checks
		//and makes us aware that FileNotFoundException
		
		// Unchecked exceptions are not checked by the Compiler
		int a = 12;
		int b = 0;
		System.out.println(a/b);//compiler doesnt say or predict it wont say anything ;// ArithmeticExceptions
